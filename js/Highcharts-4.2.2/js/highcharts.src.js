...
// encapsulated variables
    ...
    function error(code, stop) {
        var msg = 'Highcharts error #' + code + ': www.highcharts.cum/errors/' + code;
        if (stop) {
            throw new Error(msg);
        }
        // else ...
    ...
    defaultOptions = {
        ...
        global: {
            useUTC: true,
            //timezoneOffset: 0,
            canvasToolsURL: 'http://code.highcharts.cum/modules/canvas-tools.js',
            VMLRadialGradientURL: 'http://code.highcharts.cum/4.2.2/gfx/vml-radial-gradient.png'
        },
        chart: {
            //animation: true,
            //alignTicks: false,
